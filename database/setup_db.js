...
const seed = db.transaction(() => {
  ...
  // Special upcoming
  insertEvent.run(artsId, marketId, 'Christmas Market', 'Festive stalls, food, and music in the town square.', '2025-12-15', 'Town Square');
  insertEvent.run(artsId, partyId, 'New Year’s Eve Party', 'Ring in the New Year with fireworks and live music.', '2025-12-31', 'Main Plaza');
  ...
  insertEvent.run(artsId, fairId, 'Christmas Market 2024', 'Last year’s festive market.', '2024-12-15', 'Town Square');
});
